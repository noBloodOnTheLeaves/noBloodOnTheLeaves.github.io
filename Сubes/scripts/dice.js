...
(function(dice) {
    ...
    this.create_d6_geometry = function(radius) {
        ...
        return create_geom(vertices, faces, radius*2, 0.1, Math.PI / 4, 0.96);
    }
    ...
    this.known_types = ['d6', 'd6'];
    this.dice_face_range = {  'd6': [1, 6], 'd6': [1, 6] };
    this.dice_mass = { 'd6': 300, 'd6': 300};
    this.dice_inertia = {  'd6': 13, 'd6': 13};

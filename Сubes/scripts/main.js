...
//Считается значение выпавших кубиков
    
    function after_roll(notation, result) {
  
       
      
        let sumDice = $t.id('sumDice');
        let sum = 0;
        ...
        sumDice.innerHTML = sum;
        label.innerHTML = res;
        info_div.style.display = 'inline-block';//info_div скрытый элемент верстки :)
        get_Value();
    }
